...
#include "pch.h" //wouldn't let me run without this despite not actually having this file
...
static const Object entities[NUM_ENTITIES] = {
    { "quot", 4,	DOUBLE_QUOTE },
    { "amp", 3,		'&'  },
    { "apos", 4,	SINGLE_QUOTE },
    { "lt",	2, 		'<'	 },
                    ...
                    *q = LF;
                    ...
                    if ( *(p+1) == '#' ) {
                        ...
                        for( int i = 0; i < NUM_ENTITIES; ++i ) {
                            const Object& entity = entities[i];
